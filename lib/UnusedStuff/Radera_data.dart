...
if(user.user.isEmailVerified) {
  Navigator.push(context,
                        MaterialPageRoute(builder: (_) => TennisPlayerHomePage()));
} else {
  this.setState(() {
...
Widget _build = Row(children: [Text("")],);
    ...
    return Scaffold(
      ...
      body: Column(
              ...
              children: <Widget>[
                ...
                //LoginScreen
                Padding(padding: EdgeInsets.fromLTRB(12, 0, 12, 0), child: MaterialButton(
                  elevation: 0,
                  height: 70,
  ...
  borderRadius: BorderRadius.circular(40.0)),
                ...
                )), Padding(padding: EdgeInsets.fromLTRB(12, 11, 12, 0), ), Text(
