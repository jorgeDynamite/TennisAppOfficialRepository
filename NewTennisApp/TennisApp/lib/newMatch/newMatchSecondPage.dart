...
final String matchID;
  NewMatchSecondPage(this.opponentName, this.castLiveResults, this.matchID, this.yourName);
  @override
...
print("Ad value: " + ad.toString());
  ...
  if(matchFormatName == matchFormats[0]){
    returningValmatchFormat = MatchFormat(numberSets: 3, gamesPerSet: 6, tiebreak6all: true, mostSetsWinsFormat: true);
    print("0");
  }
  if(matchFormatName == matchFormats[1]){
    returningValmatchFormat = MatchFormat(numberSets: 2, gamesPerSet: 6, tiebreak6all: true, decidingSuperTiebreak: true, mostSetsWinsFormat: true);
    print("1");
  }
  if(matchFormatName == matchFormats[2]){
    returningValmatchFormat = MatchFormat(numberSets: 5, gamesPerSet: 4, tiebreak3all: true, mostSetsWinsFormat: true);
    print("2");
  }
  if(matchFormatName == matchFormats[3]){
    returningValmatchFormat = MatchFormat(numberSets: 1, gamesPerSet: 6, tiebreak6all: true, mostSetsWinsFormat: true);
    print("3");
  }
  if(matchFormatName == matchFormats[4]){
    returningValmatchFormat = MatchFormat(mostGamesWinsFormat: true, timeRestriction: 60, mostSetsWinsFormat: false);
    print("4");
  }
  if(matchFormatName == matchFormats[5]){
    returningValmatchFormat = MatchFormat(mostGamesWinsFormat: true, timeRestriction: 30, mostSetsWinsFormat: false);
    print("5");
    
  }
  if(matchFormatName == matchFormats[6]){
    returningValmatchFormat = MatchFormat(gamesPerSet: 4, timeRestriction: 60, tiebreak3all: true, mostSetsWinsFormat: true);
    print("6");
...
MatchFormat1 theMatchFormatDataPackage1(String matchFormatName) {
  List<String> matchFormats = ["Standard 3 Sets", "2 sets + ST", "5 sets to 4 games", "1 set", "60 min", "30 min", "60 min 4 games",];
  MatchFormat1 returningValmatchFormat;
...
print("Ad value: " + ad.toString());
  ...
  if(matchFormatName == matchFormats[0]){
    returningValmatchFormat = MatchFormat1(numberSets: 3, gamesPerSet: 6, tiebreak6all: true, mostSetsWinsFormat: true);
    print("0");
  }
  if(matchFormatName == matchFormats[1]){
    returningValmatchFormat = MatchFormat1(numberSets: 2, gamesPerSet: 6, tiebreak6all: true, decidingSuperTiebreak: true, mostSetsWinsFormat: true);
    print("1");
  }
  if(matchFormatName == matchFormats[2]){
    returningValmatchFormat = MatchFormat1(numberSets: 5, gamesPerSet: 4, tiebreak3all: true, mostSetsWinsFormat: true);
    print("2");
  }
  if(matchFormatName == matchFormats[3]){
    returningValmatchFormat = MatchFormat1(numberSets: 1, gamesPerSet: 6, tiebreak6all: true, mostSetsWinsFormat: true);
    print("3");
  }
  if(matchFormatName == matchFormats[4]){
    returningValmatchFormat = MatchFormat1(mostGamesWinsFormat: true, timeRestriction: 60,);
    print("4");
  }
  if(matchFormatName == matchFormats[5]){
    returningValmatchFormat = MatchFormat1(mostGamesWinsFormat: true, timeRestriction: 30,);
    print("5");
    
  }
  if(matchFormatName == matchFormats[6]){
    returningValmatchFormat = MatchFormat1(gamesPerSet: 4, timeRestriction: 60, tiebreak3all: true);
    print("6");
...
Navigator.push(context,
                MaterialPageRoute(builder: (_) => NewMatchLastPage(theMatchFormatDataPackage(matchTypeButtonText), ad, widget.opponentName, widget.castLiveResults, widget.matchID, widget.yourName, theMatchFormatDataPackage1(matchTypeButtonText))));
            } else {
