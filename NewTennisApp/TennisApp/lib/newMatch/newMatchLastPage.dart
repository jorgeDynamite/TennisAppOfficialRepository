...
import 'package:TennisApp/newMatch/thePoint/whoStartsToServe.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class NewMatchLastPage extends StatefulWidget {
  NewMatchLastPage(this.matchFormat, this.ad, this.opponentName, this.castLiveResults, this.matchID, this.yourName, this.matchFormat1);
...
class _NewMatchLastPageState extends State<NewMatchLastPage> {
  ...
  Tournament1 opponentsStats;
  String surface; 
  Matches match;
 List<int> trackedStats= [1,0,1,0,0,0,1,0,0,0,0,];
...
match = Matches(matchNumber: matchNumber, winners: trackedStats[0], doubleFaults: trackedStats[1], unforcedErrors: trackedStats[2], firstServeProcentage: trackedStats[3], secondServeProcentage: trackedStats[4], forcedErrors: trackedStats[5], aces: trackedStats[6], voleyErrors: trackedStats[7], voleyWinner: trackedStats[8], returnWinner: trackedStats[9], returnErrors: trackedStats[10]
,rules: Rules(ad: widget.ad, matchFormatVariable: widget.matchFormat), surface: surface, opponent: widget.opponentName); 

match1 = Matches1( winners: trackedStats[0], doubleFaults: trackedStats[1], unforcedErrors: trackedStats[2], firstServeProcentage: trackedStats[3], secondServeProcentage: trackedStats[4], forcedErrors: trackedStats[5], aces: trackedStats[6], voleyErrors: trackedStats[7], voleyWinner: trackedStats[8], returnWinner: trackedStats[9], returnErrors: trackedStats[10]
,rules: Rules1(ad: widget.ad, matchFormatVariable: widget.matchFormat1), surface: surface, opponent: widget.opponentName); 
...
newTournament = new Tournament(matches: [match], surface: [surface], tournamentName: tournamentName);
otherTournamnet = new Tournament(matches: [match], surface: [surface], tournamentName: tournamentName);

opponentsStats = new Tournament1(matches: [match1], surface: [surface], tournamentName: tournamentName); 
}
...
if(textFieldChangedBool){
                ...
                MaterialPageRoute(builder: (_) => WhoStartsToserve(newTournament, widget.opponentName, widget.castLiveResults, widget.matchID, otherTournamnet, widget.yourName, opponentsStats, false)));
